  ...
  return (
    <Flex className="relative w-full pt-[5.5rem] h-screen bg-retroBlue text-white flex-col overflow-hidden">
      ...
      >
        <Flex
          justify="center"
          className="absolute gap-4 flex-col top-6 sm:top-[calc(50%-5.5rem)] sm:left-[15%] font-bold text-retroWhite"
        >
        ...
        <motion.img
          ...
          alt="Retro Car"
          className="absolute z-30 bottom-6 sm:bottom-[10%] right-[-10rem] sm:right-0 max-h-[110%] w-auto"
          initial={{ x: 550 }}
          animate={{ x: -100 }}
